						...
						<View className="Betting-list" style={{ backgroundColor: 'white', padding: 10 }}>
							...
							>
								...
								>
									...
									{!isLandscape && LineGroupBarWrapInHeader ?
										<DetailLineGroupBar
											width={width}
											Lines={Lines}
								...
								</View>
								{
									...
									<View style={{flexDirection:'row'}}>
										...
										<Touch onPress={() => {
											...
											<Text style={{color: this.state.Disbandsmartcoach ? '#BCBEC3':tabactive == 2 ? '#00A6FF': '#666666',lineHeight: 40, textAlign: 'center', fontSize: 14, fontWeight: '600'}}>情报</Text>
										</Touch>
									</View>
								}
								{
