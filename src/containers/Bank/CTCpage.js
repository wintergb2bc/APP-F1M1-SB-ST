    ...
    componentWillMount() {
        if (this.props.actionType) {
            this.props.navigation.setParams({
                title: this.props.actionType == 'Deposit' ? '存款教程' : '提现教学'
            });
        } else {
            this.props.navigation.setParams({
            ...
            <View style={{ flex: 1, paddingLeft: 10 }}>
                {
                    ...
                    <View>
                        <Image
                            resizeMode='contain'
                            source={item.imgs}
                            style={{ width: width - 60, height: (width - 60) * 1.61 }}
                        />
                        {/* <Text style={{color: '#220000', fontWeight: 'bold', fontSize: 14, lineHeight: 35, paddingTop: 35}}>{item.txt1 != '' && item.txt1}</Text>
                        <Text style={{color: '#220000', fontSize: 12}}>{item.txt2 != '' && item.txt2}</Text> */}
                    </View>
                }
                {
                    // !item.imgs &&
                    ...
                    <View>
                        <View style={styles.carouselView}>
                            <Touch onPress={() => { this.carouselD(0, carouselD1) }} style={styles.btnList}>
                                <Text style={[styles.tutorialTxt, { color: tutorials == 0 ? '#fff' : '#fff' }]}>极速虚拟币支付</Text>
                            ...
                            <Touch onPress={() => { this.carouselD(2, carouselD3) }} style={styles.btnList}>
                                <Text style={[styles.tutorialTxt, { color: tutorials == 2 ? '#fff' : '#fff' }]}>虚拟币交易所 (OTC)</Text>
                            ...
                            <Touch onPress={() => { this.carouselD(1, carouselD2) }} style={styles.btnList}>
                                <Text style={[styles.tutorialTxt, { color: tutorials == 1 ? '#fff' : '#fff' }]}>虚拟币支付1</Text>
                            ...
                            <Touch onPress={() => { this.carouselD(3, carouselD4) }} style={styles.btnList}>
                                <Text style={[styles.tutorialTxt, { color: tutorials == 3 ? '#fff' : '#fff' }]}>虚拟币支付2</Text>
