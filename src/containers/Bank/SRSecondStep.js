...
import { SRPrompt } from './depositPrompt'
//小额存款第二步，SR
const {
    width, height
                            ...
                            <View style={{ flex: 1 }}>
                                <View style={styles.descReceipt}>
                                    <View style={styles.PPBDowmTime}>
                                        <Text style={{ color: '#83630B', fontSize: 12 }}>交易生成时间 {secondStepData.submittedAt && secondStepData.submittedAt.split('.')[0].replace('T', ' ') || ''}</Text>
                                        <Text style={{ color: '#83630B', fontSize: 12 }}>请在 <Text style={{ fontSize: 18, color: '#F11818' }}>{Countdown}</Text> 分钟内完成支付，或者系统自动延迟交易</Text>
                                    </View>
                                    <View style={styles.PPBamount}>
                                        <Touch style={styles.PBBamountCopy} onPress={() => { this.copy(amount, 'copyAmount') }}>
                                            <Text style={{ fontSize: 30, color: '#000', paddingRight: 5 }}><Text style={{ fontSize: 22 }}>￥</Text>{amount || ''}</Text>
                                            <Image
                                                resizeMode="stretch"
                                    ...
                                    </View>
                                    {
                                        ...
                                        <View>
                                            ...
                                            <View style={styles.PPBbankList}>
                                                ...
                                                <Touch style={styles.PPBbankConter} onPress={() => { this.copy(bankDetails.accountNumber, 'accountNumber') }}>
                                            ...
                                            <View style={styles.PPBbankList}>
                                                ...
                                                <Touch style={styles.PPBbankConter} onPress={() => { this.copy(bankDetails.accountHolderName, 'accountHolderName') }}>
                                            ...
                                            </View>
                                            {
                                                ...
                                                <View style={styles.PPBbankList}>
                                                    ...
                                                    <Touch style={styles.PPBbankConter} onPress={() => { this.copy(bankDetails.province, 'province') }}>
                                            ...
                                            }
                                            {
                                                ...
                                                <View style={styles.PPBbankList}>
                                                    ...
                                                    <Touch style={styles.PPBbankConter} onPress={() => { this.copy(bankDetails.city, 'city') }}>
                                            ...
                                            }
                                            {
                                                ...
                                                <View style={styles.PPBbankList}>
                                                    ...
                                                    <Touch style={styles.PPBbankConter} onPress={() => { this.copy(bankDetails.branch, 'branch') }}>
                                    ...
                                    <Text style={styles.descMsg} onPress={() => { LiveChatOpenGlobe() }}>如果您存款至其他账户，请联系<Text style={{ color: '#00A6FF', textDecorationLine: 'underline', fontSize: 12 }}>在线客服</Text>。</Text>
                                </View>
                        ...
                        }
                        {
                            ...
                            <View style={{ flex: 1 }}>
                                <View style={styles.PayAready}>
                                    ...
                                    />
                                    <Text style={{ fontSize: 17, color: '#000', textAlign: 'center', lineHeight: 35, paddingBottom: 15 }}>已成功提交</Text>
                                    ...
                                    <View style={styles.detials}>
                                        ...
                                        <View style={{ flexDirection: 'row' }}>
                                            <Text style={{ fontSize: 12, color: '#222222', marginRight: 10 }}>{secondStepData.transactionId || ''}</Text>
                                            <Touch onPress={() => { this.copy(secondStepData.transactionId || '') }}>
                                                <Image
                                                    resizeMode="stretch"
                                                    source={require("../../images/bank/copyIcon.png")}
                                                    style={{ width: 16, height: 16 }}
