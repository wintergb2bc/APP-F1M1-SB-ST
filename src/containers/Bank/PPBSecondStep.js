...
import { PPBPrompt } from './depositPrompt'
...
class PPBSecondStep extends React.Component {
    ...
    succesSsubmit() {
        this.Countdowns && clearInterval(this.Countdowns);
        let data = {
            'transactionId': this.state.secondStepData.transactionId,
        };
        Toast.loading('提交中,请稍候...', 200);
        fetchRequest(ApiPort.GopayLB + this.state.secondStepData.transactionId + '/ConfirmStep?', 'POST', data)
            .then((data) => {
                Toast.hide();
                if (data.isSuccess) {
            ...
            <View style={{ flex: 1 }}>
				...
				>
					<View style={styles.confirmModal}>
						...
						<Touch style={{backgroundColor: '#00A6FF', borderRadius: 8, width: width - 80, marginTop: 20, marginBottom: 15}} onPress={() => { this.setState({confirmModal: false}, () => { this.succesSsubmit() }) }}>
							<Text style={{textAlign: 'center', lineHeight: 40, color: '#fff'}}>是，我已经成功存款</Text>
						</Touch>
						<Touch style={{borderColor: '#00A6FF', borderRadius: 8, width: width - 80, borderWidth: 1}} onPress={() => { this.setState({confirmModal: false}, () => { Actions.pop() })}}>
                            ...
                            <View style={{ flex: 1 }}>
                                <View style={styles.descReceipt}>
                                    <View style={styles.PPBDowmTime}>
                                        <Text style={{ color: '#83630B', fontSize: 12 }}>请在 <Text style={{ fontSize: 18, color: '#F11818' }}>{Countdown}</Text> 分钟内完成支付和点击“我已经成功存款”</Text>
                                    </View>
                                    <View style={styles.PPBamount}>
                                        <Touch style={styles.PBBamountCopy} onPress={() => { this.copy(amount, 'copyAmount') }}>
                                            <Text style={{ fontSize: 30, color: '#0CCC3C', paddingRight: 5 }}><Text style={{ fontSize: 22 }}>￥</Text>{amount || ''}</Text>
                                            <Image
                                                resizeMode="stretch"
                                                source={require("../../images/bank/copyIcon.png")}
                                    ...
                                    </View>
                                    {
                                        ...
                                        <View>
                                            <View style={styles.PPBbankList}>
                                                ...
                                                <Touch style={styles.PPBbankConter} onPress={() => { this.copy(bankDetails.bankName, 'bankName') }}>
                                            ...
                                            <View style={styles.PPBbankList}>
                                                ...
                                                <Touch style={styles.PPBbankConter} onPress={() => { this.copy(bankDetails.bankAccountNumber, 'bankAccountNumber') }}>
                                            ...
                                            <View style={styles.PPBbankList}>
                                                ...
                                                <Touch style={styles.PPBbankConter} onPress={() => { this.copy(bankDetails.bankAccountName, 'bankAccountName') }}>
                                            ...
                                            </View>
                                            {
                                                ...
                                                <View style={styles.PPBbankList}>
                                                    ...
                                                    <Touch style={styles.PPBbankConter} onPress={() => { this.copy(bankDetails.bankProvince, 'bankProvince') }}>
                                            ...
                                            }
                                            {
                                                ...
                                                <View style={styles.PPBbankList}>
                                                    ...
                                                    <Touch style={styles.PPBbankConter} onPress={() => { this.copy(bankDetails.bankCity, 'bankCity') }}>
                                            ...
                                            }
                                            {
                                                ...
                                                <View style={styles.PPBbankList}>
                                                    ...
                                                    <Touch style={styles.PPBbankConter} onPress={() => { this.copy(bankDetails.bankBranch, 'bankBranch') }}>
                                            ...
                                            <View style={styles.PPBbankList}>
                                                ...
                                                <Touch style={styles.PPBbankConter} onPress={() => { this.copy(bankDetails.pgRemark, 'pgRemark') }}>
                                ...
                                <Touch style={styles.successBtn} onPress={() => { this.succesSsubmit() }}>
                                ...
                                <View style={styles.PayAready}>
                                    ...
                                    <View style={styles.detials}>
                                        ...
                                        <View style={{ flexDirection: 'row' }}>
                                            ...
                                            <Touch onPress={() => { this.copy(secondStepData.transactionId || '') }}><Text style={styles.copyTxt}>复制</Text></Touch>
                                        </View>
                                    </View>
