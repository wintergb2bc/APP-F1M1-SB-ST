...
class LoginOtp extends React.Component {
	...
	goSetPassword(key, type) {
		...
		Actions.SetLoginOtp({ dataPhone: this.state.phones,dataEmail: this.state.emails, verificaType: type, memberCode: this.state.memberCode,noMoreverifcation: this.noMoreverifcation, })
	}
	noMoreverifcation = () => {
