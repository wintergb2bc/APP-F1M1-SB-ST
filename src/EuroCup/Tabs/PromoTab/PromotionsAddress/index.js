...
class PromotionsAddress extends React.Component {
	...
	*/
	...
	render() {
		...
		const { id, Remark, Active, promoid, Failmsg, ShowFailPopup, Successmsg, ShowSuccessPopup, Address } = this.state;
		...
		return (
			<View style={{ flex: 1, backgroundColor: '#EFEFF4', padding: 15, }}>
				...
				>
					<Text style={{ color: '#000', fontWeight: 'bold', lineHeight: 20, marginBottom: 15 }}>FUN88 将在 30天内与您联系并寄出礼品；若没有提交表单将不能兑换此商品，且不完整和错误的信息将会使你丧失兑换礼品的权利</Text>
					{Address != '' &&
							...
							return (
								<View style={{ padding: 10, backgroundColor: '#fff', borderRadius: 10, marginBottom: 10 }} key={index}>
									...
									<Touch onPress={() => {
										...
										<Image style={{ width: 20, height: 20 }} source={require('../../../../images/euroCup/edit.png')} />
									</Touch>
